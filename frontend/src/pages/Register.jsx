    ...
    <div className="bg-brand-dark min-h-screen font-sans flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-brand-slate mt-2">Start planting your new habits.</p>
        </div>

        <form onSubmit={onSubmit} className="bg-white/5 p-8 rounded-lg shadow-2xl">
          <div className="mb-4">
            <label className="block text-brand-slate text-sm font-bold mb-2" htmlFor="name">Name</label>
            <input type="text" id="name" name="name" value={name} onChange={onChange} className="w-full bg-brand-dark text-brand-light border border-white/20 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-brand-mint" required />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-6">
            <label className="block text-brand-slate text-sm font-bold mb-2" htmlFor="password2">Confirm Password</label>
            <input type="password" id="password2" name="password2" value={password2} onChange={onChange} className="w-full bg-brand-dark text-brand-light border border-white/20 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-brand-mint" required />
          </div>
        ...
        <div className="text-center mt-6">
          <Link to="/login" className="text-sm text-brand-slate hover:text-brand-mint">Already have an account? Sign In</Link>
        </div>
      </div>
    </div>
  );
